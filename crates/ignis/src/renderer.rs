...
//! state. Use alongside a [`Device`](ignis_core::device::Device) or
//! [`WSI`](ignis_wsi::wsi::WSI).
...
use ignis_pipeline::pipeline::{PipelineCompiler, VertexInputLayout};
use ignis_pipeline::pipeline_cache::PipelineCacheManager;
use ignis_pipeline::program::Program;
use ignis_pipeline::render_pass::{RenderPassCache, RenderPassInfo};

/// Combines pipeline compilation, caching, and render pass management.
///
/// This is the recommended way to manage pipelines in ignis. Create one
