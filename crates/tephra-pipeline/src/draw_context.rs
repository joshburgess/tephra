...
use tephra_command::command_buffer::CommandBuffer;
use tephra_command::state::StaticPipelineState;
use tephra_descriptors::binding_table::{BindingTable, MAX_DESCRIPTOR_SETS};
use tephra_descriptors::cache::{DescriptorSetCache, PreparedDescriptorWrites};
...
impl<'a> DrawContext<'a> {
    ...
    pub fn set_stencil_front(
        ...
        self.state.stencil_front = tephra_command::state::StencilFaceState {
            fail_op,
            depth_fail_op,
            pass_op,
            compare_op,
    ...
    pub fn set_stencil_back(
        ...
        self.state.stencil_back = tephra_command::state::StencilFaceState {
            fail_op,
            depth_fail_op,
            pass_op,
            compare_op,
    ...
    /// The loader can be obtained from [`Context::push_descriptor_device()`](tephra_core::context::Context::push_descriptor_device).
